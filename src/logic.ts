export const version: string = "1.3.28" // need to declare this before imports since several imports utilize it
...
export function info(): InfoResponse {
    ...
    if (isShovel) { // shovel
      response = {
        ...
        author: "waryferryman",
        color: "#ff99e6", // #ff9900
        head: "evil", //"tiger-king",
        tail: "replit-notmark", //"mystic-moon",
        version: version
      }
