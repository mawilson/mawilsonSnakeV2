...
export class GameData {
  ...
  evaluationsForMachineLearning: {[key: string]: SnakeScore} // a record of average snake scores gotten from database used to determine threshold for machine learnings
  ...
  // would have also been grouped together by the DB
