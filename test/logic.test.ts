...
describe('sinkhole tests', () => {
  ...
  // tricky case. Allowed deepening because only works on lookahead 6/7 or better, but Shapeshifter only has a few moves, so this lookahead should be attainable
