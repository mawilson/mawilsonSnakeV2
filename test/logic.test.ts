...
describe('islands and bridges tests', () => {
  ...
  // valuable test that only succeeds on lookahead 7 or better. Removing useTailChase when otherSnake Voronoi > mine in minimax pushed it in the right direction.
  ...
  // only succeeds on lookahead 7 or better, which it may not be performant enough to reach
