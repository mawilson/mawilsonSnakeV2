...
describe('hazard pit tests', () => {
  ...
  it.skip('hazardPit10: chooses a potential tie over a potential cutoff against hazard', () => {
...
describe('islands and bridges tests', () => {
  it.skip('islandsBridges1: does not walk into a corner after guessing MaxN moves wrong', () => {
  ...
  it('islandsBridges3: does not allowed itself to be cornered in MaxN', () => {
